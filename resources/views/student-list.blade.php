    ...
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
        <tr v-for="student in students">
          <td>@{{student.name}}</td>
          <td><span class="badge bg-label-warning">@{{student.standard}}</span></td>
        ...
        <div class="modal-body">
          <div class="row mb-2">
            <div class="col-12">
              ...
              <input class="form-control form-control-sm" type="text" v-model="formData.name">
            </div>
            <div class="col-12">
              <label class="form-label">पिता का नाम</label>
              <input class="form-control form-control-sm" type="text" v-model="formData.father_name">
            </div>
            <div class="col-4">
              <label class="form-label">कक्षा</label>
              <select class="form-select form-select-sm" aria-label="Default select example" v-model="formData.standard">
                <option value="" selected>कक्षा</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <div class="col-4">
              ...
              <select class="form-select form-select-sm" aria-label="Default select example" v-model="formData.medium">
            ...
            <div class="col-4">
              ...
              <select class="form-select form-select-sm" aria-label="Default select example" v-model="formData.fee_type">
            ...
            <div class="col-4">
              ...
              <input class="form-control form-control-sm" type="text" v-model="formData.contact">
            </div>
            <div class="col-4">
              <label class="form-label">पंजीक्रम</label>
              <input class="form-control form-control-sm" type="text" v-model="formData.roll_no">
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-12">
